# Hilight-Studio-PlusPlusV3 (Build `a1.2.9` / v3.9) - Changelog & Modifications Log

This document provides a comprehensive record of all custom modifications, architectural enhancements, user directives, and privacy protections implemented in **Hilight-Studio-PlusPlusV3** (version `a1.2.9` / v3.9, incorporating upstream [DhananjayBhosale/hilight-studio](https://github.com/DhananjayBhosale/hilight-studio) v1.0.9 stuck LED mitigations, safety overrides, zero wake-lock battery optimization, and on-device AI system isolation).
