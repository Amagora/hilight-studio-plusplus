# Hi-Light Studio V2 (Build `a1.1.0`) - Changelog & Modifications Log

This document provides a comprehensive record of all custom modifications, architectural enhancements, user directives, and privacy protections implemented in **Hi-Light Studio V2** (version `a1.1.0`, forked from [DhananjayBhosale/hilight-studio](https://github.com/DhananjayBhosale/hilight-studio) v1.0.8-experimental).
